...
create or replace view VIEW_GARAJ_GARAJ as select g.garaj_kodu as bas_garaj_kodu, g2.garaj_kodu as bit_garaj_kodu,
...
from garaj g inner join garaj g2 on g.garaj_kodu != g2.garaj_kodu where g.durumu = 1 and g2.durumu = 1
